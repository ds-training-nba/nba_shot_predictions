...
def worst_prediction_failures(y_proba, y_test):
    """
    filter and sort most confident mispredictions
    :param y_proba:
    :param y_test:
...
def get_false_predictions(config: RunConfig):
    """
    Run training+prediction pipeline. Get false prediction sorted by worst confidence and merged with original inputs and filtered for relevant
    input cols only
    :param config:
    :return:
    """
